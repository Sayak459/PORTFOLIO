...
//         <div className="absolute inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_50%,#63e_80%)]"></div>
//       </div>
...
const App = () => {
  ...
  return (
    <div className={`${isDarkMode ? 'text-neutral-300' : 'text-neutral-900'} overflow-x-hidden antialiased`}>
      {/* Dynamic Background */}
